...
urlpatterns = [
    ...
    path('agregar_materias_produccion/<int:id>/',views.agregar_materias_produccion, name='agregar_materias_produccion'),
    path('eliminar_produccion/<int:id>/',views.eliminar_produccion, name='eliminar_produccion'),
